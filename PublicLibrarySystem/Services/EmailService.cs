...
namespace PublicLibrarySystem.Services
{
    ...
    public class EmailService : IEmailService
    {
        ...
        private readonly PublicLibrarySystemContext context;

        public EmailService(PublicLibrarySystemContext _context)
        {
            context = _context;
        }
        ...
        public async Task SendEmail(string userName, string title, bool? isSecure, string bodyHtml, bool? isImportantTag, string? ccEmail, string? bccEmail)
        {
            ...
            var requestBody = new
            {
                ...
                CreatedName = "Public Library System No-Reply",
                IsSecure = isSecure,
                BodyHtml = bodyHtml,
